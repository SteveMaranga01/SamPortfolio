    ...
    <section id='projects' className='py-32 relative overflow-hidden'>
      ...
      <div className='conatiner mx-auto px-6 relative z-10'>
        ...
        className='text-center mx-auto max-w-3xl mb-16'>
          ...
          <p className='text-muted-foreground animate-fade-in animation-delay-700'>
            ...
            <div key={idx} className='group glass rounded-2xl overflow-hidden animate-fade-in md:row-span-1'>
              ...
              <div className='p-6 space-y-4'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  border border-border/50 text-muted-foreground hover:border-primary/50 hover:text-primary transition-all duration-300'>{tag}</span>
                ))}
                </div>
              </div>
            </div>
